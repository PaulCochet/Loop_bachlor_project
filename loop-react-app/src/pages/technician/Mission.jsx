...
const TechnicianMission = () => {
  ...
  return (
    <div className="bg-white min-h-screen pb-32">
      {/* TopAppBar */}
      <header className="bg-white/80 backdrop-blur-xl text-[#1a1c1b] sticky top-0 z-50 px-6 pt-16 pb-4 flex justify-between items-end">
        {/* Back Button */}
      ...
      <main className="px-6 pt-8">
        <div className="flex items-center gap-4 mb-10">
          ...
          <span className="px-3 py-1 bg-[#f2f2f0] text-[#8C8C8C] text-[10px] font-bold uppercase tracking-widest rounded-full">À venir</span>
        </div>

        <div className="space-y-6">
          {/* Card 1: Usager */}
          <section className="bg-white p-6 rounded-xl shadow-[0_0_32px_0_rgba(0,0,0,0.04)] relative overflow-hidden border border-gray-100">
            ...
            <div className="pt-4 border-t border-gray-100 flex items-center gap-2">
              <span className="material-symbols-outlined text-[#003cdd] text-sm">schedule</span>
              <p className="text-sm font-bold text-[#1a1c1b]">Demain 9h00 à 11h00</p>
            </div>
          </section>

          {/* Card 2: Appareil */}
          <section className="bg-[#f9f9f7] p-6 rounded-xl relative overflow-hidden border border-gray-100">
            ...
            <div className="flex gap-6">
              ...
              <div className="space-y-2">
                ...
                <div className="space-y-1">
                  <p className="text-xs text-[#8C8C8C] font-bold uppercase tracking-wider">Problème</p>
                  <p className="text-sm font-medium text-[#464545]">S'arrête en cours de cycle</p>
                </div>
                <div className="inline-flex items-center gap-2 px-2 py-1 bg-red-50 text-red-600 rounded text-[10px] font-black uppercase tracking-tighter italic">
                  Error Code: E21
                </div>
              </div>
            </div>
          ...
          <section className="bg-[#eeeeec] p-6 rounded-xl">
            <h3 className="text-[10px] font-bold uppercase tracking-widest text-[#8C8C8C] mb-4">Pièces suggérées à embarquer</h3>
            <ul className="space-y-3">
              {[
                ...
                <li key={i} className="flex items-start gap-3">
                  <span className="w-1.5 h-1.5 rounded-full bg-[#003cdd] mt-1.5 flex-shrink-0"></span>
        ...
        <div className="mt-12 pb-12">
          <motion.button 
            ...
            className="w-full bg-[#1a1c1b] text-white py-5 rounded-xl font-black uppercase italic tracking-widest text-lg shadow-xl flex items-center justify-center gap-3"
          >
            Démarrer la mission
